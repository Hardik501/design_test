                     ...
                     <Menu open={item.name === data && menuList}
                          onClose={()=>setMenuList(false)}
                           ...
                           onRequestClose={()=>setMenuList(false)}
                            style={{top:35}}
                    >
                        <div className="subMenu" onMouseLeave={()=>setMenuList(false)}> { item.list.map((list)=>(<MenuItem className="list" >
                            {list}
                        </MenuItem>))}</div>
                    </Menu>
               </Typography>
            ...
            <Container className="drawer">
               <div className="div">
                   ...
                   <IconButton className="mobileResponsiveAvtar">
                       <div className={editPhoto ?'Profile-photo add-border':'Profile-photo'} onClick={HandleImageSetting}>
                   ...
                   {subList.map((item, index)=>(
                       <Typography component={'div'} className="menulist">
